...
int info(int indAlun), alterar(int indAlun, int opt), cadastro(int indAlun);
			...
			case 3:
				do{
					...
					for(int i=0; i<3; i++) {
						...
						if(Aluno[optAlun-1].notas[i] > 10 || Aluno[optAlun-1].notas[i] < 0) {
							while(Aluno[optAlun-1].notas[i] > 10 || Aluno[optAlun-1].notas[i] < 0) {
...
int alterar(int indAlun, int opt) {
	...
	while(opt != 0) {
		...
		if(Aluno[optAlun-1].notas[optAlter-1] > 10 || Aluno[optAlun-1].notas[optAlter-1] < 0) {
			while(Aluno[optAlun-1].notas[optAlter-1] > 10 || Aluno[optAlun-1].notas[optAlter-1] < 0) {
